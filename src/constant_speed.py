...
PATH_OK_DIFF_YAW = 0.21             # This use ok yaw to don't rotation again 
PATH_LAST_TIME = 5
...
STRATEGY_TIME_BUOY = 1                      # This is time to forward search direct after path
...
STRATEGY_ROTATION_EXPOSED = -math.pi/4      # This use to rotation from drop to exposed
